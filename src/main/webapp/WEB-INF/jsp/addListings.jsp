...
<html>
    ...
    <body>
        ...
        <h3>Please enter your details to add the House Listings for rent</h3>
        <h3></h3>
        <div class="container">
            <form method="post" action="addListings.htm">
                <input type="file" name="imageFile">
                <label>Enter the Property Name: </label>
                <input type="text" name="pname"><!-- comment -->
                <label>Enter the Property Rent: </label>
                <input type="text" name="prent"><!-- comment -->
                <label>Enter the No of Baths: </label><!-- comment -->
                <input type="text" name="noOfBaths"><!-- comment -->
                <label>Enter the No of Beds: </label>
                <input type="text" name="noOfBeds">
                <label>Enter the Location </label>
                <input type="text" name="location">
                <label>Enter the Availability Date: </label>
                <input type="date" name="date"><!-- comment -->
